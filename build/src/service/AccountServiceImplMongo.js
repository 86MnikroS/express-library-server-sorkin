...
export class AccountServiceImplMongo {
    changePassword(id, newPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const account = yield ReaderModel.findById(id);
            if (!account)
    ...
    createAccount(reader) {
        return __awaiter(this, void 0, void 0, function* () {
            const temp = yield ReaderModel.findById(reader._id);
            if (temp)
    ...
    editAccount(id, updReader) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield ReaderModel.findByIdAndUpdate(id, {
    ...
    getAccount(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield ReaderModel.findById(id).lean().exec();
    ...
    removeAccount(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield ReaderModel.findByIdAndDelete(id);
            if (!result)
                throw new HttpError(404, "Account not found");
            const { _id, username, email, passHash, birthDate, roles } = result;
            return { _id, username, email, passHash, birthDate, roles };
